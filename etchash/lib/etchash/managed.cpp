...
const etchash_epoch_context* etchash_get_global_epoch_context(int epoch_number) noexcept
{
...
const etchash_epoch_context_full* etchash_get_global_epoch_context_full(int epoch_number) noexcept
{
    // Check if local context matches epoch number.
