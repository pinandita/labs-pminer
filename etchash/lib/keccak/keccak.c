...
union etchash_hash256 etchash_keccak256(const uint8_t* data, size_t size)
{
    union etchash_hash256 hash;
    keccak(hash.word64s, 256, data, size);
    return hash;
}

union etchash_hash256 etchash_keccak256_32(const uint8_t data[32])
{
    union etchash_hash256 hash;
...
union etchash_hash512 etchash_keccak512(const uint8_t* data, size_t size)
{
    union etchash_hash512 hash;
    keccak(hash.word64s, 512, data, size);
    return hash;
}

union etchash_hash512 etchash_keccak512_64(const uint8_t data[64])
{
    union etchash_hash512 hash;
